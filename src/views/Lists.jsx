...
const makeDraft = (payload = {}) => ({
  ...
  allowRoles: Array.isArray(payload.whitelist?.roles)
    ? payload.whitelist.roles
    : [],
  ...
  return (
    <div className="ceog-page ceog-lists-page">
      ...
      <div className="ceog-list-precedence" role="status">
        ...
        <div>
          <strong>
            {__("Whitelist always wins", "coderembassy-order-vanguard")}
          </strong>
          <span>
            {__(
        ...
        <div className="ceog-list-grid">
          <section className="ceog-list-panel ceog-list-panel--block">
            ...
            <ListField
              ...
              description={__(
                "Exact email addresses, one per line.",
                "coderembassy-order-vanguard",
              )}
            ...
            <ListField
              ...
              description={__(
                "Domain names without @, one per line.",
                "coderembassy-order-vanguard",
              )}
          ...
          <section className="ceog-list-panel ceog-list-panel--allow">
            ...
            <div className="ceog-list-field-icon">
              ...
              <ListField
                ...
                description={__(
                  "IPv6 exceptions cover the entered /64 network.",
                  "coderembassy-order-vanguard",
                )}
            ...
            <SearchMultiSelect
              ...
              description={__(
                "Search and select the roles that should always bypass protection.",
                "coderembassy-order-vanguard",
              )}
              icon={UserRoundCheck}
              ...
              searchPlaceholder={__(
                "Search WordPress roles...",
                "coderembassy-order-vanguard",
              )}
              emptyText={__(
                "No matching WordPress roles.",
                "coderembassy-order-vanguard",
              )}
            />
            <SearchMultiSelect
